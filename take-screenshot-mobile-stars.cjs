...
(async () => {
    ...
    try {
        ...
        console.log('Taking mobile screenshot of the TESTIMONIAL section...');
        await page.screenshot({ path: 'c:/Users/panoj/Documents/Clientes/Villaviciosa/client/public/screenshot-mobile-stars.png', fullPage: false });
