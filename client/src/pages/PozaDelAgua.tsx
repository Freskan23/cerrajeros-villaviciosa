...
export default function PozaDelAgua() {
  return (
    <ZoneLanding
      zoneName="El Bosque"
      zoneDescription="Servicio de cerrajería urgente en El Bosque. Conocemos los sistemas de seguridad de tu barrio y ofrecemos soluciones rápidas."
      ...
      commonProblems={[
        ...
        "Atención rápida para vecinos de El Bosque.",
      ]}
    />
  );
}
