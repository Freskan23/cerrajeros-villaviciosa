...
export default function LaFortuna() {
  return (
    <ZoneLanding
      zoneName="Castillo"
      zoneDescription="¿Urgencia en Castillo? Estamos al lado del Parque Serafín Díez Antón. Llegamos antes de que te des cuenta."
      ...
      commonProblems={[
        "Abrimos puertas en las casas bajas y pisos de Castillo.",
