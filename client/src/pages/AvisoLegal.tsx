        ...
        <section className="py-16">
          <div className="container max-w-4xl">
            ...
            <div className="prose prose-lg max-w-none space-y-6 text-gray-700">
              ...
              <p>
                Usted está visitando la página web www.cerrajeriavillaviciosa24h.com, titularidad de <strong>{APP_BUSINESS_LEGAL_NAME}</strong>, con domicilio social en <strong>{APP_LEGAL_ADDRESS}</strong>, con NIF <strong>{APP_NIF}</strong>, en adelante, el TITULAR.
              </p>
              ...
              <p>
                En el caso de que en www.cerrajeriavillaviciosa24h.com se incluyesen enlaces o hipervínculos hacia otros sitios de Internet, el Titular no ejercerá ningún tipo de control sobre dichos sitios y contenidos ni asumirá responsabilidad alguna por los contenidos de algún enlace perteneciente a un sitio web ajeno, ni garantizará la disponibilidad técnica, calidad, fiabilidad, exactitud, amplitud, veracidad, validez y constitucionalidad de cualquier material o información contenida en ninguno de dichos hipervínculos u otros sitios de Internet.
              </p>
