...
export default function ArroyoCulebro() {
  return (
    <ZoneLanding
      zoneName="Río Guadarrama"
      zoneDescription="¿Vives en los chalets o pisos de Río Guadarrama? Conocemos bien la zona y llegamos rápido por la M-50."
      ...
      commonProblems={[
        ...
        "Especialistas en puertas de chalets y unifamiliares de Río Guadarrama.",
