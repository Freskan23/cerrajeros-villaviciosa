...
export default function SanNicasio() {
  return (
    <ZoneLanding
      zoneName="El Bosque"
      zoneDescription="¿Problemas con la cerradura en El Bosque? Atendemos urgencias en la zona de la Ermita, Río Duero y alrededores en tiempo récord."
      ...
      commonProblems={[
        "Abrimos puertas antiguas y modernas en todo el barrio de El Bosque.",
