                ...
                <section className="relative py-20 bg-[#001529] overflow-hidden">
                    ...
                    <div className="container relative z-10">
                        <nav className="flex items-center text-sm text-gray-400 mb-8">
                            ...
                            <span className="text-[#FF6B35] font-bold">Contacto</span>
                        </nav>
                    ...
                    <div className="container">
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 -mt-32">
                            ...
                            <div className="bg-white rounded-[32px] p-8 shadow-[0_24px_48px_-12px_rgba(0,0,0,0.08)] border border-gray-100 hover:scale-[1.02] transition-transform flex flex-col items-center text-center">
                                <div className="bg-[#FF6B35]/10 p-5 rounded-3xl mb-6">
                        ...
                        <div className="mt-24 grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
                            ...
                            <div className="space-y-12">
                                <div>
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                        ...
                                        <div className="flex items-center gap-3">
                                            <CheckCircle className="text-green-500 h-5 w-5" />
                                            <span className="font-bold text-gray-700">Técnicos Colegiados</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="bg-gray-50 rounded-[40px] p-10 border border-gray-100">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="flex justify-between items-center pt-2">
                                            <span className="font-black text-[#FF6B35] uppercase italic">Servicio Urgente</span>
                                            <span className="font-black text-[#FF6B35]">24 HORAS / 365 DÍAS</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="relative">
                                <div className="absolute -inset-4 bg-[#004E89]/5 rounded-[3rem] transform -rotate-2"></div>
